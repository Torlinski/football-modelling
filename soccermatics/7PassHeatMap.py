...
with open('/home/greg/Documents/football/data/statsbomb/data/matches/'+str(competition_id)+'/30.json') as f:
    matches = json.load(f)
...
for ic,match_id in enumerate(match_id_required):
    ...
    with open('/home/greg/Documents/football/data/statsbomb/data/events/'+file_name) as data_file:
