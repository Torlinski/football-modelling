...
statsbomb_path = '/home/greg/Documents/football/data/statsbomb/data'
...
with open(os.path.join(statsbomb_path, 'matches/'+str(competition_id)+'/30.json')) as f:
    matches = json.load(f)
...
for match in matches:
    ...
    with open(os.path.join(statsbomb_path, 'events/'+file_name)) as data_file:
